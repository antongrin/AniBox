...
fcamp_an = ComputeAzFCReflection(vp_t, vs_t, dn_t, de_t, ep_t, ga_t, fi0_t, fi_list_sparse, th_list)
rugeramp_az = ComputeRugerReflection(vp_t, vs_t, dn_t, de_t, ep_t, ga_t, fi0_t, fi_list, th_list_sparse)
fcamp_az = ComputeAzFCReflection(vp_t, vs_t, dn_t, de_t, ep_t, ga_t, fi0_t, fi_list, th_list_sparse)
...
PlotRugerAmp(ax_az_akir, fcamp_az, ind_t_top[Model_no], ang_list_sparse, az_list, cmap = cm.Accent, vid = 'Az')
PlotRugerAmp(ax_an_akir, fcamp_an, ind_t_top[Model_no], ang_list, az_list_sparse, cmap = cm.Accent, vid = 'An')
